...
/**
 * Define the ASN1 Type DataReceipt from ASN1 Module SEMI.
 * @see Sequence
 */
...
public class DataReceipt extends Sequence implements BEREncodable, BERDecodable, DEREncodable, PEREncodable, PERDecodable {
     ...
     */
    public DataReceipt(SemiDialogID dialogID, SemiSequenceID seqID, 
		    GroupID groupID, 
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, DataReceipt data)
    ...
    {
	try {
	    return DataReceipt.encodeValue(coder, sink, this);
	} catch (Exception e) {
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "DataReceipt");
	    throw ee;
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public static DataReceipt decodeValue(PerCoder coder, InputBitStream source, DataReceipt data)
    ...
    {
	try {
	    DataReceipt.decodeValue(coder, source, this);
	    return this;
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
    ...
    {
	return equalTo((DataReceipt)that);
    }
    ...
    public boolean equalTo(DataReceipt that) {
     ...
     * Clone 'this' object.
     */
    public DataReceipt clone() {
	DataReceipt copy = (DataReceipt)super.clone();
	...
	{
	    return new DataReceipt();
	}
    };
    
} // End class definition for DataReceipt
