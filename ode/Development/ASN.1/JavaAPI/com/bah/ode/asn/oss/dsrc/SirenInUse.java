...
/**
 * Define the ASN1 Type SirenInUse from ASN1 Module DSRC.
 * @see Enumerated
 */
...
public final class SirenInUse extends Enumerated {
    ...
    public static final SirenInUse unavailable =
	new SirenInUse();
    public static final SirenInUse notInUse =
	new SirenInUse(1);
    public static final SirenInUse inUse =
	new SirenInUse(2);
    public static final SirenInUse reserved =
	new SirenInUse(3);
