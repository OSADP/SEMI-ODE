...
/**
 * Define the ASN1 Type Capacity from ASN1 Module SEMI.
 * @see INTEGER
 */

public class Capacity extends INTEGER {
	...
	Capacity copy = (Capacity)super.clone();
	copy.setValue(this.longValue());
	return copy;
    }

} // End class definition for Capacity
