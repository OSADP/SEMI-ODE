...
public final class StabilityControlStatus extends Enumerated {
    ...
    public StabilityControlStatus(long value)
    {
	super(value);
    }
    ...
    public static final StabilityControlStatus unavailable =
	new StabilityControlStatus();
    public static final StabilityControlStatus off =
	new StabilityControlStatus(1);
    public static final StabilityControlStatus on =
     ...
     */
    public final static StabilityControlStatus cNamedNumbers[] = {
	 unavailable, 
	 off, 
	 on
    };
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public static StabilityControlStatus valueAt(int index)
    {
	if (index < 0 || index >= 3)
     ...
     * Clone 'this' object.
     */
    public StabilityControlStatus clone() {
	return (StabilityControlStatus)super.clone();
    }
