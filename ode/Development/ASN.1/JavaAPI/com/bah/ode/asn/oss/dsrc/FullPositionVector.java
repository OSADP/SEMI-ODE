...
public class FullPositionVector extends Sequence {
	...
	boolean has_utcTime0 = data.utcTime != null;
	boolean has_elevation0 = data.elevation != null;
	...
	sink.writeBit(has_utcTime0); ++nbits;
	sink.writeBit(has_elevation0); ++nbits;
	...
	if (has_utcTime0) {
		...
		DDateTime.decodeValue(coder, source, data.utcTime);
	    } catch (Exception e) {
