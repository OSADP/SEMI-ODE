...
public class IntersectionSituationDataBundle extends Sequence implements BEREncodable, BERDecodable, DEREncodable, PEREncodable, PERDecodable {
		...
		throws IOException, DecoderException, DecodeFailedException
	{
		...
		try {
		    ...
		    IntersectionBundle.decodeValue(coder, source, item1);
		} catch (Exception e) {
    ...
    {
	try {
	    return IntersectionSituationDataBundle.encodeValue(coder, sink, this);
	} catch (Exception e) {
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "IntersectionSituationDataBundle");
	    throw ee;
	...
	try {
	    ...
	    IsdBundles.decodeValue(coder, source, data.isdBundles);
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
    ...
    {
	try {
	    IntersectionSituationDataBundle.decodeValue(coder, source, this);
	    return this;
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
