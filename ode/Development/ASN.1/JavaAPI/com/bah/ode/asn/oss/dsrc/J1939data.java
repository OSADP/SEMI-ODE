...
public class J1939data extends Sequence {
	...
	public static class Sequence_ extends Sequence {
		...
		boolean has_location0 = data.location != null;
		boolean has_pressure0 = data.pressure != null;
		boolean has_temp0 = data.temp != null;
		boolean has_wheelSensorStatus0 = data.wheelSensorStatus != null;
		boolean has_wheelEndElectFault0 = data.wheelEndElectFault != null;
		boolean has_leakageRate0 = data.leakageRate != null;
		boolean has_detection0 = data.detection != null;
		sink.writeBit(false); ++nbits;
		sink.writeBit(has_location0); ++nbits;
		sink.writeBit(has_pressure0); ++nbits;
		sink.writeBit(has_temp0); ++nbits;
		sink.writeBit(has_wheelSensorStatus0); ++nbits;
		sink.writeBit(has_wheelEndElectFault0); ++nbits;
		sink.writeBit(has_leakageRate0); ++nbits;
		sink.writeBit(has_detection0); ++nbits;
		if (has_location0) {
	...
	public static class Sequence_ extends Sequence {
		...
		boolean has_location0 = data.location != null;
		boolean has_weight0 = data.weight != null;
		sink.writeBit(false); ++nbits;
		sink.writeBit(has_location0); ++nbits;
		sink.writeBit(has_weight0); ++nbits;
		if (has_location0) {
		    // Encode field 'location'
		    try {
	...
	boolean has_tires0 = data.tires != null;
	boolean has_axle0 = data.axle != null;
	boolean has_trailerWeight0 = data.trailerWeight != null;
	boolean has_cargoWeight0 = data.cargoWeight != null;
	boolean has_steeringAxleTemperature0 = data.steeringAxleTemperature != null;
	boolean has_driveAxleLocation0 = data.driveAxleLocation != null;
	boolean has_driveAxleLiftAirPressure0 = data.driveAxleLiftAirPressure != null;
	boolean has_driveAxleTemperature0 = data.driveAxleTemperature != null;
	boolean has_driveAxleLubePressure0 = data.driveAxleLubePressure != null;
	boolean has_steeringAxleLubePressure0 = data.steeringAxleLubePressure != null;
	sink.writeBit(false); ++nbits;
	sink.writeBit(has_tires0); ++nbits;
	sink.writeBit(has_axle0); ++nbits;
	sink.writeBit(has_trailerWeight0); ++nbits;
	sink.writeBit(has_cargoWeight0); ++nbits;
	sink.writeBit(has_steeringAxleTemperature0); ++nbits;
	sink.writeBit(has_driveAxleLocation0); ++nbits;
	sink.writeBit(has_driveAxleLiftAirPressure0); ++nbits;
	sink.writeBit(has_driveAxleTemperature0); ++nbits;
	sink.writeBit(has_driveAxleLubePressure0); ++nbits;
	sink.writeBit(has_steeringAxleLubePressure0); ++nbits;
	if (has_tires0) {
	    // Encode field 'tires'
	    try {
	...
	if (has_tires0) {
		...
		Tires.decodeValue(coder, source, data.tires);
	    } catch (Exception e) {
		DecoderException de = DecoderException.wrapException(e);
	...
	if (has_axle0) {
		...
		if (data.axle == null)
		    data.axle = new Axle();
		Axle.decodeValue(coder, source, data.axle);
	    } catch (Exception e) {
		DecoderException de = DecoderException.wrapException(e);
