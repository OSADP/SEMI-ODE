...
/**
 * Define the ASN1 Type TirePressure from ASN1 Module DSRC.
 * @see INTEGER
 */

public class TirePressure extends INTEGER {
    ...
    public TirePressure(short value)
    {
	super(value);
    }
    
    public TirePressure(int value)
    {
	super(value);
    }
