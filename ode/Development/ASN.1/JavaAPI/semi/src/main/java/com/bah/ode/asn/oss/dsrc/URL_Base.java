...
/**
 * Define the ASN1 Type URL_Base from ASN1 Module DSRC.
 * @see IA5String
 */
...
public class URL_Base extends IA5String {
     ...
     * Clone 'this' object.
     */
    public URL_Base clone() {
	return (URL_Base)super.clone();
    }

} // End class definition for URL_Base
