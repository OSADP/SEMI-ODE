...
/**
 * Define the ASN1 Type RainSensor from ASN1 Module DSRC.
 * @see Enumerated
 */
...
public final class RainSensor extends Enumerated {
    ...
    public static final RainSensor none =
	new RainSensor();
    public static final RainSensor lightMist =
	new RainSensor(1);
    public static final RainSensor heavyMist =
	new RainSensor(2);
    public static final RainSensor lightRainOrDrizzle =
	new RainSensor(3);
    public static final RainSensor rain =
	new RainSensor(4);
    public static final RainSensor moderateRain =
	new RainSensor(5);
    public static final RainSensor heavyRain =
	new RainSensor(6);
    public static final RainSensor heavyDownpour =
	new RainSensor(7);
