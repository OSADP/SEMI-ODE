...
public class VehSitRecord extends Sequence {
	...
	sink.writeBit(data.vehstat != null);
	sink.writeBit(data.weather != null);
	sink.writeBit(data.env != null);
	sink.writeBit(data.elveh != null);
	nbits += 4;
	// Encode field 'tempID'
	try {
	...
	try {
	    ...
	    data.time.decodeValue(coder, source, data.time);
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
	...
	try {
	    ...
	    data.pos.decodeValue(coder, source, data.pos);
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
	...
	try {
	    ...
	    data.fundamental.decodeValue(coder, source, data.fundamental);
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
	...
	if (has_vehstat0) {
		...
		data.vehstat.decodeValue(coder, source, data.vehstat);
	    } catch (Exception e) {
		DecoderException de = DecoderException.wrapException(e);
	...
	if (has_weather0) {
		...
		data.weather.decodeValue(coder, source, data.weather);
	    } catch (Exception e) {
		DecoderException de = DecoderException.wrapException(e);
	...
	if (has_env0) {
		...
		data.env.decodeValue(coder, source, data.env);
	    } catch (Exception e) {
		DecoderException de = DecoderException.wrapException(e);
	...
	if (has_elveh0) {
		...
		data.elveh.decodeValue(coder, source, data.elveh);
	    } catch (Exception e) {
		DecoderException de = DecoderException.wrapException(e);
    ...
    public int hashCode() {
	int hash = 3;
	hash = 41 * hash + (this.tempID != null ? this.tempID.hashCode() : 0);
	hash = 41 * hash + (this.time != null ? this.time.hashCode() : 0);
	hash = 41 * hash + (this.pos != null ? this.pos.hashCode() : 0);
	hash = 41 * hash + (this.fundamental != null ? this.fundamental.hashCode() : 0);
	hash = 41 * hash + (this.vehstat != null ? this.vehstat.hashCode() : 0);
	hash = 41 * hash + (this.weather != null ? this.weather.hashCode() : 0);
	hash = 41 * hash + (this.env != null ? this.env.hashCode() : 0);
	hash = 41 * hash + (this.elveh != null ? this.elveh.hashCode() : 0);
	return hash;
    }
