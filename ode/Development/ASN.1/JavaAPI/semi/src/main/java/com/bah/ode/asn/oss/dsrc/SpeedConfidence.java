...
public final class SpeedConfidence extends Enumerated {
    ...
    public SpeedConfidence(long value)
    {
	super(value);
    }
    ...
    public static final SpeedConfidence unavailable =
	new SpeedConfidence();
    public static final SpeedConfidence prec100ms =
	new SpeedConfidence(1);
    public static final SpeedConfidence prec10ms =
	new SpeedConfidence(2);
    public static final SpeedConfidence prec5ms =
	new SpeedConfidence(3);
    public static final SpeedConfidence prec1ms =
	new SpeedConfidence(4);
    public static final SpeedConfidence prec0_1ms =
	new SpeedConfidence(5);
    public static final SpeedConfidence prec0_05ms =
	new SpeedConfidence(6);
    public static final SpeedConfidence prec0_01ms =
