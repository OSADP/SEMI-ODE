...
/**
 * Define the ASN1 Type ITIStext from ASN1 Module ITIS.
 * @see IA5String
 */
...
public class ITIStext extends IA5String {
     ...
     * Clone 'this' object.
     */
    public ITIStext clone() {
	return (ITIStext)super.clone();
    }

} // End class definition for ITIStext
