...
public final class LightbarInUse extends Enumerated {
    ...
    public static final LightbarInUse sirenInUse = cNamedNumbers[3];
    public static final LightbarInUse yellowCautionLights = cNamedNumbers[4];
    public static final LightbarInUse schooldBusLights = cNamedNumbers[5];
    public static final LightbarInUse arrowSignsActive = cNamedNumbers[6];
    public static final LightbarInUse slowMovingVehicle = cNamedNumbers[7];
    public static final LightbarInUse freqStops = cNamedNumbers[8];
    public static final LightbarInUse reserved = cNamedNumbers[9];
