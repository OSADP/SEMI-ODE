...
public final class SteeringWheelAngleConfidence extends Enumerated {
    ...
    public static final SteeringWheelAngleConfidence unavailable = cNamedNumbers[0];
    public static final SteeringWheelAngleConfidence prec2deg = cNamedNumbers[1];
    public static final SteeringWheelAngleConfidence prec1deg = cNamedNumbers[2];
    public static final SteeringWheelAngleConfidence prec0_02deg = cNamedNumbers[3];
