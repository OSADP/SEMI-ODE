...
/**
 * Define the ASN1 Type WorkZone from ASN1 Module DSRC.
 * @see SequenceOf
 */

public class WorkZone extends SequenceOf {
	...
	try {
		...
		try {
		    int len2 = 0;
		    com.bah.ode.asn.oss.dsrc.WorkZone.Sequence_.Item temp2 = temp0.get(idx0).item;

		    switch (temp2.getChosenFlag()) {
		    case com.bah.ode.asn.oss.dsrc.WorkZone.Sequence_.Item.itis_chosen:
			try {
		    ...
		    case com.bah.ode.asn.oss.dsrc.WorkZone.Sequence_.Item.text_chosen:
			try {
	    ...
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendElementContext(null, "WorkZone", idx0);
	    throw ee;
	}
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public WorkZone decodeValue(BerCoder coder, DecoderInput source)
	...
	try {
		    ...
		    source.raiseTagMismatchException(tag);
		{
			...
			source.raiseTagMismatchException(tag);
		    try {
			temp0.item = new com.bah.ode.asn.oss.dsrc.WorkZone.Sequence_.Item();
			{
			    int indef_tags2 = 0;
			    ...
			    case 0x80:
				try {
				    temp0.item.setChosenFlag(com.bah.ode.asn.oss.dsrc.WorkZone.Sequence_.Item.itis_chosen);
			    ...
			    case 0x81:
				try {
				    temp0.item.setChosenFlag(com.bah.ode.asn.oss.dsrc.WorkZone.Sequence_.Item.text_chosen);
