...
public final class PedestrianSignalState extends Enumerated {
    ...
    public static final PedestrianSignalState unavailable = cNamedNumbers[0];
    public static final PedestrianSignalState stop = cNamedNumbers[1];
    public static final PedestrianSignalState caution = cNamedNumbers[2];
    public static final PedestrianSignalState walk = cNamedNumbers[3];
