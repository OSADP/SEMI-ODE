...
public final class WiperStatusRear extends Enumerated {
    ...
    public static final WiperStatusRear unavailable = cNamedNumbers[0];
    public static final WiperStatusRear off = cNamedNumbers[1];
    public static final WiperStatusRear intermittent = cNamedNumbers[2];
    public static final WiperStatusRear low = cNamedNumbers[3];
    public static final WiperStatusRear high = cNamedNumbers[4];
    public static final WiperStatusRear washerInUse = cNamedNumbers[5];
    public static final WiperStatusRear automaticPresent = cNamedNumbers[6];
