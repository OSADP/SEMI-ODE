...
public final class DirectionOfUse extends Enumerated {
    ...
    public static final DirectionOfUse forward = cNamedNumbers[0];
    public static final DirectionOfUse reverse = cNamedNumbers[1];
    public static final DirectionOfUse both = cNamedNumbers[2];
