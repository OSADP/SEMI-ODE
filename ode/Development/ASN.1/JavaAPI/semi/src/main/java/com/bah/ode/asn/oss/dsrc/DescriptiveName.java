...
/**
 * Define the ASN1 Type DescriptiveName from ASN1 Module DSRC.
 * @see IA5String
 */
...
public class DescriptiveName extends IA5String {
     ...
     */
    public DescriptiveName(char[] value)
    {
	super(value);
    }
     ...
     * Clone 'this' object.
     */
    public DescriptiveName clone() {
	return (DescriptiveName)super.clone();
    }

} // End class definition for DescriptiveName
