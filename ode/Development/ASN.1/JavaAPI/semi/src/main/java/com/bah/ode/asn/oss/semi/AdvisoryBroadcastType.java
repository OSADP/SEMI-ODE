...
public final class AdvisoryBroadcastType extends Enumerated {
    ...
    public static final AdvisoryBroadcastType spatAggregate = cNamedNumbers[0];
    public static final AdvisoryBroadcastType map = cNamedNumbers[1];
    public static final AdvisoryBroadcastType tim = cNamedNumbers[2];
    public static final AdvisoryBroadcastType ev = cNamedNumbers[3];
