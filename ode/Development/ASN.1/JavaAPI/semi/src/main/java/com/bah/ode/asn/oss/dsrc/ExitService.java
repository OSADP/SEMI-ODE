...
public class ExitService extends SequenceOf {
	...
	try {
		...
		try {
		    int len2 = 0;
		    com.bah.ode.asn.oss.dsrc.ExitService.Sequence_.Item temp2 = temp0.get(idx0).item;

		    switch (temp2.getChosenFlag()) {
		    case com.bah.ode.asn.oss.dsrc.ExitService.Sequence_.Item.itis_chosen:
			try {
		    ...
		    case com.bah.ode.asn.oss.dsrc.ExitService.Sequence_.Item.text_chosen:
			try {
	    ...
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendElementContext(null, "ExitService", idx0);
	    throw ee;
	}
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public ExitService decodeValue(BerCoder coder, DecoderInput source)
	...
	try {
		    ...
		    source.raiseTagMismatchException(tag);
		{
			...
			source.raiseTagMismatchException(tag);
		    try {
			temp0.item = new com.bah.ode.asn.oss.dsrc.ExitService.Sequence_.Item();
			{
			    int indef_tags2 = 0;
			    ...
			    case 0x80:
				try {
				    temp0.item.setChosenFlag(com.bah.ode.asn.oss.dsrc.ExitService.Sequence_.Item.itis_chosen);
			    ...
			    case 0x81:
				try {
				    temp0.item.setChosenFlag(com.bah.ode.asn.oss.dsrc.ExitService.Sequence_.Item.text_chosen);
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, ExitService data)
	    throws IOException, EncoderException, EncodeFailedException
    {
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public static ExitService decodeValue(PerCoder coder, InputBitStream source, ExitService data)
	    throws IOException, DecoderException, DecodeFailedException
    {
	int total_len0 = 0;
	int fragmentLength0;
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public ExitService decodeValue(JsonCoder coder, JsonReader source)
	throws IOException, DecoderException
{
    int total_len0 = 0;
    int idx0 = 0;
    ...
    public boolean abstractEqualTo(AbstractData that)
    {
	return equalTo((ExitService)that);
    }
    ...
    public boolean equalTo(ExitService that) {
     ...
     * Clone 'this' object.
     */
    public ExitService clone() {
	ExitService copy = (ExitService)super.clone();
