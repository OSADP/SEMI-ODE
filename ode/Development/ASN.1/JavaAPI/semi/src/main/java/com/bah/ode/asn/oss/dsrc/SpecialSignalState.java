...
public final class SpecialSignalState extends Enumerated {
    ...
    public static final SpecialSignalState unknown = cNamedNumbers[0];
    public static final SpecialSignalState notInUse = cNamedNumbers[1];
    public static final SpecialSignalState arriving = cNamedNumbers[2];
    public static final SpecialSignalState present = cNamedNumbers[3];
    public static final SpecialSignalState departing = cNamedNumbers[4];
