...
/**
 * Define the ASN1 Type WheelEndElectFault from ASN1 Module DSRC.
 * @see BitString
 */

public class WheelEndElectFault extends BitString {
     ...
     */
    public WheelEndElectFault(byte[] value)
    {
	super(value);
    }
     ...
     */
    public WheelEndElectFault(byte[] value, int sigBits)
    {
	super(value, sigBits);
    }
    
    // Named list definitions.
    public static final int bitOne = 1;
    public static final int bitTwo = 2;
    public static final int bitThree = 3;
    public static final int bitFour = 4;
