...
public class SpeedandHeadingandThrottleConfidence extends OctetString {
    ...
    public SpeedandHeadingandThrottleConfidence(byte[] value)
    {
	super(value);
    }
	...
	return (SpeedandHeadingandThrottleConfidence)super.clone();
    }
