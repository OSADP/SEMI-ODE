...
/**
 * Define the ASN1 Type ObjectDiscoveryDataRequest from ASN1 Module SEMI.
 * @see Sequence
 */

public class ObjectDiscoveryDataRequest extends Sequence implements BEREncodable, BERDecodable, DEREncodable, JSONEncodable, JSONDecodable, PEREncodable, PERDecodable {
     ...
     */
    public ObjectDiscoveryDataRequest()
    {
    }
     ...
     */
    public ObjectDiscoveryDataRequest(SemiDialogID dialogID, 
		    SemiSequenceID seqID, GroupID groupID, 
		    com.bah.ode.asn.oss.dsrc.TemporaryID requestID, 
		    ServiceID serviceID, GeoRegion serviceRegion)
    {
	...
	try {
	    int len0 = 0;
	    ObjectDiscoveryDataRequest temp0 = this;
	    ...
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "ObjectDiscoveryDataRequest");
	    throw ee;
	}
    }
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, ObjectDiscoveryDataRequest data)
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public static ObjectDiscoveryDataRequest decodeValue(PerCoder coder, InputBitStream source, ObjectDiscoveryDataRequest data)
	...
	try {
	    ...
	    DecoderException de = DecoderException.wrapException(e);
	    de.appendFieldContext(null, "ObjectDiscoveryDataRequest");
	    throw de;
	}
    }
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public ObjectDiscoveryDataRequest decodeValue(JsonCoder coder, JsonReader source)
	...
	if (coder.hasMoreProperties(source, true))
		...
		ObjectDiscoveryDataRequest.__Tag t_tag0 = ObjectDiscoveryDataRequest.__Tag.getTagSub(tag0);
		if (t_tag0 == null) 
		    t_tag0 = ObjectDiscoveryDataRequest.__Tag._null_;
		switch (t_tag0) {
		    case __dialogID:
		    // Decode field 'dialogID'
		    try {
    ...
    {
	return "ObjectDiscoveryDataRequest";
    }
    ...
    {
	return equalTo((ObjectDiscoveryDataRequest)that);
    }
    ...
    public boolean equalTo(ObjectDiscoveryDataRequest that) {
     ...
     * Clone 'this' object.
     */
    public ObjectDiscoveryDataRequest clone() {
	ObjectDiscoveryDataRequest copy = (ObjectDiscoveryDataRequest)super.clone();
	...
	{
	    return new ObjectDiscoveryDataRequest();
	}
    };
    
} // End class definition for ObjectDiscoveryDataRequest
