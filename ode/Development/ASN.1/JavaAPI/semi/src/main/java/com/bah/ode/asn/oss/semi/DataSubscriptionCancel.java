...
/**
 * Define the ASN1 Type DataSubscriptionCancel from ASN1 Module SEMI.
 * @see Sequence
 */

public class DataSubscriptionCancel extends Sequence implements BEREncodable, BERDecodable, DEREncodable, JSONEncodable, JSONDecodable, PEREncodable, PERDecodable {
     ...
     */
    public DataSubscriptionCancel(SemiDialogID dialogID, SemiSequenceID seqID, 
		    GroupID groupID, 
	...
	try {
	    int len0 = 0;
	    DataSubscriptionCancel temp0 = this;
	    ...
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "DataSubscriptionCancel");
	    throw ee;
	}
    }
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, DataSubscriptionCancel data)
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public static DataSubscriptionCancel decodeValue(PerCoder coder, InputBitStream source, DataSubscriptionCancel data)
	...
	try {
	    ...
	    DecoderException de = DecoderException.wrapException(e);
	    de.appendFieldContext(null, "DataSubscriptionCancel");
	    throw de;
	}
    }
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public DataSubscriptionCancel decodeValue(JsonCoder coder, JsonReader source)
	...
	if (coder.hasMoreProperties(source, true))
		...
		DataSubscriptionCancel.__Tag t_tag0 = DataSubscriptionCancel.__Tag.getTagSub(tag0);
		if (t_tag0 == null) 
		    t_tag0 = DataSubscriptionCancel.__Tag._null_;
		switch (t_tag0) {
		    case __dialogID:
		    // Decode field 'dialogID'
		    try {
    ...
    {
	return equalTo((DataSubscriptionCancel)that);
    }
    ...
    public boolean equalTo(DataSubscriptionCancel that) {
     ...
     * Clone 'this' object.
     */
    public DataSubscriptionCancel clone() {
	DataSubscriptionCancel copy = (DataSubscriptionCancel)super.clone();
	...
	{
	    return new DataSubscriptionCancel();
	}
    };
    
} // End class definition for DataSubscriptionCancel
