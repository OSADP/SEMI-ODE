...
public class DataAcceptance extends Sequence implements BEREncodable, BERDecodable, DEREncodable, JSONEncodable, JSONDecodable, PEREncodable, PERDecodable {
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public DataAcceptance decodeValue(JsonCoder coder, JsonReader source)
	...
	if (coder.hasMoreProperties(source, true))
		...
		DataAcceptance.__Tag t_tag0 = DataAcceptance.__Tag.getTagSub(tag0);
		if (t_tag0 == null) 
		    t_tag0 = DataAcceptance.__Tag._null_;
		switch (t_tag0) {
		    case __dialogID:
		    // Decode field 'dialogID'
		    try {
