...
/**
 * Define the ASN1 Type IntersectionSituationDataAcceptance from ASN1 Module SEMI.
 * @see Sequence
 */

public class IntersectionSituationDataAcceptance extends Sequence implements BEREncodable, BERDecodable, DEREncodable, JSONEncodable, JSONDecodable, PEREncodable, PERDecodable {
     ...
     */
    public IntersectionSituationDataAcceptance()
    {
    }
     ...
     */
    public IntersectionSituationDataAcceptance(SemiDialogID dialogID, 
    ...
    // Methods for field "recordsSent"
    public long getRecordsSent()
    {
	return (this.recordsSent).longValue();
    }
    
    public void setRecordsSent(long recordsSent)
    {
	setRecordsSent(new INTEGER(recordsSent));
    }
	...
	try {
	    int len0 = 0;
	    IntersectionSituationDataAcceptance temp0 = this;

	    try {
		len0 += sink.encodeLengthTag(coder.encodeInteger(temp0.recordsSent, sink), 0x84);
	    } catch (Exception e) {
		EncoderException ee = EncoderException.wrapException(e);
		ee.appendFieldContext("recordsSent", "INTEGER");
		throw ee;
	    }
	    try {
	    ...
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "IntersectionSituationDataAcceptance");
	    throw ee;
	}
    }
	...
	try {
		...
		if (tag != 0x84)
		    source.raiseTagMismatchException(tag);
		try {
		    this.recordsSent = new INTEGER(source.decodeLong());
		} catch (Exception e) {
		    DecoderException ee = DecoderException.wrapException(e);
		    ee.appendFieldContext("recordsSent", "INTEGER");
		    throw ee;
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, IntersectionSituationDataAcceptance data)
	...
	// Encode field 'recordsSent'
	try {
	    INTEGER item1 = data.recordsSent;
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public static IntersectionSituationDataAcceptance decodeValue(PerCoder coder, InputBitStream source, IntersectionSituationDataAcceptance data)
	...
	// Decode field 'recordsSent'
	try {
	    long temp1;

	    if (data.recordsSent == null)
		data.recordsSent = new INTEGER();
	    temp1 = coder.decodeConstrainedWholeNumber(source, 1, 32767);
	    if (temp1 > 32767)
		throw new DecoderException(com.oss.util.ExceptionDescriptor._valueRange, null, temp1);
	    data.recordsSent.setValue(temp1);
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
	    de.appendFieldContext("recordsSent", "INTEGER");
	    throw de;
	}
	return data;
    }
	...
	try {
	    ...
	    DecoderException de = DecoderException.wrapException(e);
	    de.appendFieldContext(null, "IntersectionSituationDataAcceptance");
	    throw de;
	}
    }
	...
	// Encode field 'recordsSent'
	try {
	    INTEGER item1 = this.recordsSent;

	    {
		sink.writeSeparator();
		sink.encodeKey("recordsSent");
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public IntersectionSituationDataAcceptance decodeValue(JsonCoder coder, JsonReader source)
	...
	if (coder.hasMoreProperties(source, true))
		...
		IntersectionSituationDataAcceptance.__Tag t_tag0 = IntersectionSituationDataAcceptance.__Tag.getTagSub(tag0);
		if (t_tag0 == null) 
		    t_tag0 = IntersectionSituationDataAcceptance.__Tag._null_;
		switch (t_tag0) {
		    case __dialogID:
		    // Decode field 'dialogID'
		    try {
			...
			if (present0[4])
			    throw new DecoderException(ExceptionDescriptor._field_repeat, null);
			if (this.recordsSent == null)
			    this.recordsSent = new INTEGER();
			this.recordsSent.setValue(coder.decodeInteger(source));
			present0[4] = true;
		    } catch (Exception e) {
			DecoderException de = DecoderException.wrapException(e);
			de.appendFieldContext("recordsSent", "INTEGER");
	...
	if (!present0[4])
	    throw new DecoderException(ExceptionDescriptor._field_omit, ": 'recordsSent'");
	return this;
    }
	...
	try {
	    writer.print(',');
	    printer.newLine(writer);
	    writer.print("recordsSent ");
	    writer.print(this.recordsSent.longValue());
	} catch (Exception e) {
	    printer.reportError(e, null, writer);
	}
	printer.undent();
    ...
    {
	return "IntersectionSituationDataAcceptance";
    }
    ...
    {
	return equalTo((IntersectionSituationDataAcceptance)that);
    }
    ...
    public boolean equalTo(IntersectionSituationDataAcceptance that) {
	...
	if (!this.requestID.equalTo(that.requestID))
	    return false;
	if (!this.recordsSent.equalTo(that.recordsSent))
	    return false;
	return true;
    }
     ...
     * Clone 'this' object.
     */
    public IntersectionSituationDataAcceptance clone() {
	IntersectionSituationDataAcceptance copy = (IntersectionSituationDataAcceptance)super.clone();
	copy.dialogID = dialogID.clone();
	copy.seqID = seqID.clone();
	copy.groupID = groupID.clone();
	copy.requestID = requestID.clone();
	copy.recordsSent = recordsSent.clone();
	return copy;
    }
	...
	hash = 41 * hash + (this.recordsSent != null ? this.recordsSent.hashCode() : 0);
	return hash;
    }
    /**
     * The type is a PDU.
	...
	{
	    return new IntersectionSituationDataAcceptance();
	}
    };
    
} // End class definition for IntersectionSituationDataAcceptance
