...
call C:\apache\maven\3.2.5\bin\mvn install:install-file -DcreateChecksum=true -Dpackaging=jar -Dfile=target\semi-2.2.jar -DgroupId=asn.1 -DartifactId=semi -Dversion=2.2
pause