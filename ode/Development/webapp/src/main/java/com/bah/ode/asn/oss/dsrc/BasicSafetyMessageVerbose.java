...
public class BasicSafetyMessageVerbose extends Sequence implements BEREncodable, BERDecodable, DEREncodable, PEREncodable, PERDecodable {
    ...
    {
	try {
	    return BasicSafetyMessageVerbose.encodeValue(coder, sink, this);
	} catch (Exception e) {
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "BasicSafetyMessageVerbose");
	    throw ee;
	...
	try {
	    ...
	    VehicleSize.decodeValue(coder, source, data.size);
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
    ...
    {
	try {
	    BasicSafetyMessageVerbose.decodeValue(coder, source, this);
	    return this;
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
