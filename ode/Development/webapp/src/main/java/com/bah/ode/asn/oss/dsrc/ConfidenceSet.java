...
public class ConfidenceSet extends Sequence {
	...
	boolean has_accelConfidence0 = data.accelConfidence != null;
	boolean has_speedConfidence0 = data.speedConfidence != null;
	boolean has_timeConfidence0 = data.timeConfidence != null;
	boolean has_posConfidence0 = data.posConfidence != null;
	boolean has_steerConfidence0 = data.steerConfidence != null;
	boolean has_throttleConfidence0 = data.throttleConfidence != null;
	sink.writeBit(false); ++nbits;
	sink.writeBit(has_accelConfidence0); ++nbits;
	sink.writeBit(has_speedConfidence0); ++nbits;
	sink.writeBit(has_timeConfidence0); ++nbits;
	sink.writeBit(has_posConfidence0); ++nbits;
	sink.writeBit(has_steerConfidence0); ++nbits;
	sink.writeBit(has_throttleConfidence0); ++nbits;
	...
	if (has_accelConfidence0) {
		...
		AccelSteerYawRateConfidence.decodeValue(coder, source, data.accelConfidence);
	    } catch (Exception e) {
