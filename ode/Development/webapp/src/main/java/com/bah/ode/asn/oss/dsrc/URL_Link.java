...
/**
 * Define the ASN1 Type URL_Link from ASN1 Module DSRC.
 * @see IA5String
 */
...
public class URL_Link extends IA5String {
     ...
     * Clone 'this' object.
     */
    public URL_Link clone() {
	return (URL_Link)super.clone();
    }

} // End class definition for URL_Link
