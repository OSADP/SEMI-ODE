...
/**
 * Define the ASN1 Type SpecialLane from ASN1 Module DSRC.
 * @see Sequence
 */

public class SpecialLane extends Sequence {
    public LaneNumber laneNumber;
    public LaneWidth laneWidth;
    public SpecialLaneAttributes laneAttributes;
     ...
     */
    public SpecialLane(LaneNumber laneNumber, LaneWidth laneWidth, 
		    SpecialLaneAttributes laneAttributes, NodeList nodeList, 
     ...
     */
    public SpecialLane(LaneNumber laneNumber, 
		    SpecialLaneAttributes laneAttributes, NodeList nodeList)
    {
	setLaneNumber(laneNumber);
	setLaneAttributes(laneAttributes);
    ...
    public SpecialLaneAttributes getLaneAttributes()
    {
	return this.laneAttributes;
    }
    
    public void setLaneAttributes(SpecialLaneAttributes laneAttributes)
    {
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public SpecialLane decodeValue(BerCoder coder, DecoderInput source)
	...
	do {
		...
		this.laneAttributes = SpecialLaneAttributes.cNamedNumbers[idx1];
	    } catch (Exception e) {
		DecoderException ee = DecoderException.wrapException(e);
		ee.appendFieldContext("laneAttributes", "SpecialLaneAttributes");
		throw ee;
		...
		try {
		    ...
		    DecoderException ee = DecoderException.wrapException(e);
		    ee.appendExtensionContext("SpecialLane", -1);
		    throw ee;
		}
		if (source.position() >= end_pos0)
		    break;
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public static int encodeValue(PerCoder coder, OutputBitStream sink, SpecialLane data)
	...
	try {
	    SpecialLaneAttributes item1 = data.laneAttributes;
     ...
     * This method is reserved for internal use and must not be invoked from the application code.
     */
    public static SpecialLane decodeValue(PerCoder coder, InputBitStream source, SpecialLane data)
	...
	try {
	    ...
	    data.laneAttributes = SpecialLaneAttributes.valueAt(idx1);
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
    ...
    {
	return equalTo((SpecialLane)that);
    }
    ...
    public boolean equalTo(SpecialLane that) {
     ...
     * Clone 'this' object.
     */
    public SpecialLane clone() {
	SpecialLane copy = (SpecialLane)super.clone();
...
} // End class definition for SpecialLane
