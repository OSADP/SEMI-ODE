...
/**
 * Define the ASN1 Type ServiceProviderID from ASN1 Module SEMI.
 * @see OctetString
 */

public class ServiceProviderID extends OctetString {
    ...
    public ServiceProviderID(byte[] value)
    {
	super(value);
    }
     ...
     * Clone 'this' object.
     */
    public ServiceProviderID clone() {
	return (ServiceProviderID)super.clone();
    }

} // End class definition for ServiceProviderID
