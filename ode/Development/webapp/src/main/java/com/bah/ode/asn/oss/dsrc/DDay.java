...
/**
 * Define the ASN1 Type DDay from ASN1 Module DSRC.
 * @see INTEGER
 */

public class DDay extends INTEGER {
     ...
     */
    public DDay clone() {
	DDay copy = (DDay)super.clone();
	copy.setValue(this.longValue());
	return copy;
    }

} // End class definition for DDay
