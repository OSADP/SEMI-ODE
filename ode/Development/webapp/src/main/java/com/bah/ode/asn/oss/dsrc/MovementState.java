...
public class MovementState extends Sequence {
	...
	boolean has_movementName0 = data.movementName != null;
	boolean has_laneCnt0 = data.laneCnt != null;
	boolean has_currState0 = data.currState != null;
	boolean has_pedState0 = data.pedState != null;
	boolean has_specialState0 = data.specialState != null;
	boolean has_stateConfidence0 = data.stateConfidence != null;
	boolean has_yellState0 = data.yellState != null;
	boolean has_yellPedState0 = data.yellPedState != null;
	boolean has_yellTimeToChange0 = data.yellTimeToChange != null;
	boolean has_yellStateConfidence0 = data.yellStateConfidence != null;
	boolean has_vehicleCount0 = data.vehicleCount != null;
	boolean has_pedDetect0 = data.pedDetect != null;
	boolean has_pedCount0 = data.pedCount != null;
	sink.writeBit(false); ++nbits;
	sink.writeBit(has_movementName0); ++nbits;
	sink.writeBit(has_laneCnt0); ++nbits;
	sink.writeBit(has_currState0); ++nbits;
	sink.writeBit(has_pedState0); ++nbits;
	sink.writeBit(has_specialState0); ++nbits;
	sink.writeBit(has_stateConfidence0); ++nbits;
	sink.writeBit(has_yellState0); ++nbits;
	sink.writeBit(has_yellPedState0); ++nbits;
	sink.writeBit(has_yellTimeToChange0); ++nbits;
	sink.writeBit(has_yellStateConfidence0); ++nbits;
	sink.writeBit(has_vehicleCount0); ++nbits;
	sink.writeBit(has_pedDetect0); ++nbits;
	sink.writeBit(has_pedCount0); ++nbits;
