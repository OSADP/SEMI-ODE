...
/**
 * Define the ASN1 Type DistributionType from ASN1 Module SEMI.
 * @see OctetString
 */

public class DistributionType extends OctetString {
    ...
    public DistributionType(byte[] value)
    {
	super(value);
    }
	...
	return (DistributionType)super.clone();
    }

} // End class definition for DistributionType
