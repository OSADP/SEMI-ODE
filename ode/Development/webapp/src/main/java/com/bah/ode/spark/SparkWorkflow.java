...
public class SparkWorkflow extends OdeObject {
   private static final long serialVersionUID = 1706616704417070349L;
   ...
   public SparkWorkflow(AppContext appContext) {
      ...
      this.ssc = appContext.getSparkStreamingConext();
   }



   public void setup(final MQTopicInOut ioTopic) {
      ...
      for (int i = 0; i < ioTopic.getInTopic().getPartitions(); i++) {
         JavaPairDStream<String, String> aStream = KafkaUtils
               .createStream(appContext.getSparkStreamingConext(), appContext
                     .getParam(AppContext.ZK_CONNECTION_STRINGS), String
                     .valueOf(id), Collections.singletonMap(ioTopic
                     .getInTopic().getName(), ioTopic.getInTopic()
                     .getPartitions()));
                ...
                new VoidFunction<Iterator<Tuple2<String,String>>>() {
                  ...
                  public void call(Iterator<
                     ...
                     while (partitionOfRecords.hasNext()) {
                        ...
                        producer.send(AppContext.VSD_OUTBOUND_TOPIC, 
                              record._1(), record._2());
                     }
