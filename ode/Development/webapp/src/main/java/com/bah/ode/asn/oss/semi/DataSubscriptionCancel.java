...
public class DataSubscriptionCancel extends Sequence implements BEREncodable, BERDecodable, DEREncodable, PEREncodable, PERDecodable {
    ...
    {
	try {
	    return DataSubscriptionCancel.encodeValue(coder, sink, this);
	} catch (Exception e) {
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "DataSubscriptionCancel");
	    throw ee;
    ...
    {
	try {
	    DataSubscriptionCancel.decodeValue(coder, source, this);
	    return this;
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
