...
/**
 * Define the ASN1 Type EssSolarRadiation from ASN1 Module NTCIP.
 * @see INTEGER
 */

public class EssSolarRadiation extends INTEGER {
    ...
    public EssSolarRadiation(short value)
    {
	super(value);
    }
    
    public EssSolarRadiation(int value)
    {
	super(value);
    }
     ...
     * Clone 'this' object.
     */
    public EssSolarRadiation clone() {
	EssSolarRadiation copy = (EssSolarRadiation)super.clone();
	copy.setValue(this.longValue());
	return copy;
    }

} // End class definition for EssSolarRadiation
