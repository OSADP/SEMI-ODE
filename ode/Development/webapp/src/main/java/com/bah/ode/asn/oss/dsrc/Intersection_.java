...
public class Intersection_ extends Sequence {
		...
		throws IOException, DecoderException, DecodeFailedException
	{
		...
		try {
		    ...
		    ApproachObject.decodeValue(coder, source, item1);
		} catch (Exception e) {
		...
		throws IOException, DecoderException, DecodeFailedException
	{
		...
		try {
		    ...
		    data.elements.add(item1);
		    SignalControlZone.decodeValue(coder, source, item1);
		} catch (Exception e) {
		    DecoderException de = DecoderException.wrapException(e);
	...
	boolean has_refPoint0 = data.refPoint != null;
	boolean has_refInterNum0 = data.refInterNum != null;
	boolean has_orientation0 = data.orientation != null;
	boolean has_laneWidth0 = data.laneWidth != null;
	boolean has_type0 = data.type != null;
	boolean has_preemptZones0 = data.preemptZones != null;
	boolean has_priorityZones0 = data.priorityZones != null;
	sink.writeBit(false); ++nbits;
	sink.writeBit(has_name0); ++nbits;
	sink.writeBit(has_refPoint0); ++nbits;
	sink.writeBit(has_refInterNum0); ++nbits;
	sink.writeBit(has_orientation0); ++nbits;
	sink.writeBit(has_laneWidth0); ++nbits;
	sink.writeBit(has_type0); ++nbits;
	sink.writeBit(has_preemptZones0); ++nbits;
	sink.writeBit(has_priorityZones0); ++nbits;
	if (has_name0) {
	    // Encode field 'name'
	    try {
	...
	if (has_refPoint0) {
		...
		Position3D.decodeValue(coder, source, data.refPoint);
	    } catch (Exception e) {
		DecoderException de = DecoderException.wrapException(e);
	...
	try {
	    ...
	    Approaches.decodeValue(coder, source, data.approaches);
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
	...
	if (has_preemptZones0) {
		...
		PreemptZones.decodeValue(coder, source, data.preemptZones);
	    } catch (Exception e) {
		DecoderException de = DecoderException.wrapException(e);
	...
	if (has_priorityZones0) {
		...
		PriorityZones.decodeValue(coder, source, data.priorityZones);
	    } catch (Exception e) {
		DecoderException de = DecoderException.wrapException(e);
