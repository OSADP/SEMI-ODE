...
public class ServiceRecord extends Sequence {
		...
		throws IOException, DecoderException, DecodeFailedException
	{
		...
		try {
		    ...
		    ConnectionPoint.decodeValue(coder, source, item1);
		} catch (Exception e) {
	...
	try {
	    ...
	    nbits += (ConnectionPoints.encodeValue(coder, sink, item1));
	} catch (Exception e) {
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext("connectionPoints", "SEQUENCE OF");
	    throw ee;
	...
	try {
	    ...
	    ConnectionPoints.decodeValue(coder, source, data.connectionPoints);
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
	...
	try {
	    ...
	    SvcPSIDs.decodeValue(coder, source, data.svcPSIDs);
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
