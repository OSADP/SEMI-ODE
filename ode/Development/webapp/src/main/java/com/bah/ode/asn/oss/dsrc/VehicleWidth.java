...
/**
 * Define the ASN1 Type VehicleWidth from ASN1 Module DSRC.
 * @see INTEGER
 */

public class VehicleWidth extends INTEGER {
    ...
    public VehicleWidth(short value)
    {
	super(value);
    }
     ...
     * Clone 'this' object.
     */
    public VehicleWidth clone() {
	VehicleWidth copy = (VehicleWidth)super.clone();
	copy.setValue(this.longValue());
	return copy;
    }

} // End class definition for VehicleWidth
