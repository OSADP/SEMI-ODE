...
/**
 * Define the ASN1 Type RTCM_ID from ASN1 Module DSRC.
 * @see INTEGER
 */

public class RTCM_ID extends INTEGER {
    ...
    public RTCM_ID(short value)
    {
	super(value);
    }
    
    public RTCM_ID(int value)
    {
	super(value);
    }
    
    public RTCM_ID(long value)
    {
	super(value);
    }
     ...
     * Clone 'this' object.
     */
    public RTCM_ID clone() {
	RTCM_ID copy = (RTCM_ID)super.clone();
	copy.setValue(this.longValue());
	return copy;
    }

} // End class definition for RTCM_ID
