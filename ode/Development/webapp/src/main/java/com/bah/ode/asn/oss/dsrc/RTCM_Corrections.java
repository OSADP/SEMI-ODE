...
public class RTCM_Corrections extends Sequence implements BEREncodable, BERDecodable, DEREncodable, PEREncodable, PERDecodable {
		...
		throws IOException, DecoderException, DecodeFailedException
	{
		...
		try {
		    ...
		    RTCMmsg.decodeValue(coder, source, item1);
		} catch (Exception e) {
    ...
    {
	try {
	    return RTCM_Corrections.encodeValue(coder, sink, this);
	} catch (Exception e) {
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "RTCM-Corrections");
	    throw ee;
	...
	try {
	    ...
	    RtcmSets.decodeValue(coder, source, data.rtcmSets);
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
    ...
    {
	try {
	    RTCM_Corrections.decodeValue(coder, source, this);
	    return this;
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
