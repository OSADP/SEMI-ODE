...
/**
 * Define the ASN1 Type FurtherInfoID from ASN1 Module DSRC.
 * @see OctetString
 */

public class FurtherInfoID extends OctetString {
    ...
    public FurtherInfoID(byte[] value)
    {
	super(value);
    }
     ...
     * Clone 'this' object.
     */
    public FurtherInfoID clone() {
	return (FurtherInfoID)super.clone();
    }

} // End class definition for FurtherInfoID
