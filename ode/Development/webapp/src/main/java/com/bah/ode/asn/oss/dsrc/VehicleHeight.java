...
/**
 * Define the ASN1 Type VehicleHeight from ASN1 Module DSRC.
 * @see INTEGER
 */

public class VehicleHeight extends INTEGER {
    ...
    public VehicleHeight(short value)
    {
	super(value);
    }
    
    public VehicleHeight(int value)
    {
	super(value);
    }
     ...
     * Clone 'this' object.
     */
    public VehicleHeight clone() {
	VehicleHeight copy = (VehicleHeight)super.clone();
	copy.setValue(this.longValue());
	return copy;
    }

} // End class definition for VehicleHeight
