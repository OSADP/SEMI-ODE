...
public final class SemiSequenceID extends Enumerated {
    ...
    public static final SemiSequenceID svcReq =
	new SemiSequenceID();
    public static final SemiSequenceID svcResp =
	new SemiSequenceID(2);
    public static final SemiSequenceID dataReq =
	new SemiSequenceID(3);
    public static final SemiSequenceID dataConf =
	new SemiSequenceID(4);
    public static final SemiSequenceID data =
	new SemiSequenceID(5);
    public static final SemiSequenceID accept =
	new SemiSequenceID(6);
    public static final SemiSequenceID receipt =
	new SemiSequenceID(7);
    public static final SemiSequenceID subscriptionReq =
	new SemiSequenceID(8);
    public static final SemiSequenceID subscriptinoResp =
	new SemiSequenceID(9);
    public static final SemiSequenceID subscriptionCancel =
