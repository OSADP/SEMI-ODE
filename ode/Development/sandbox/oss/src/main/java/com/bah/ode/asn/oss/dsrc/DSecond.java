...
/**
 * Define the ASN1 Type DSecond from ASN1 Module DSRC.
 * @see INTEGER
 */

public class DSecond extends INTEGER {
     ...
     * Clone 'this' object.
     */
    public DSecond clone() {
	DSecond copy = (DSecond)super.clone();
	copy.setValue(this.longValue());
	return copy;
    }

} // End class definition for DSecond
