...
/**
 * Define the ASN1 Type VehicleLength from ASN1 Module DSRC.
 * @see INTEGER
 */

public class VehicleLength extends INTEGER {
    ...
    public VehicleLength(short value)
    {
	super(value);
    }
     ...
     * Clone 'this' object.
     */
    public VehicleLength clone() {
	VehicleLength copy = (VehicleLength)super.clone();
	copy.setValue(this.longValue());
	return copy;
    }

} // End class definition for VehicleLength
