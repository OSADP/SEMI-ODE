...
public class DataSubscriptionResponse extends Sequence implements BEREncodable, BERDecodable, DEREncodable, PEREncodable, PERDecodable {
	...
	boolean has_err0 = data.err != null;
	sink.writeBit(has_err0); ++nbits;
    ...
    {
	try {
	    return DataSubscriptionResponse.encodeValue(coder, sink, this);
	} catch (Exception e) {
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "DataSubscriptionResponse");
	    throw ee;
    ...
    {
	try {
	    DataSubscriptionResponse.decodeValue(coder, source, this);
	    return this;
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
