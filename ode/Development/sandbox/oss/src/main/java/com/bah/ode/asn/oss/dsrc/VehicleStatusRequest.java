...
public class VehicleStatusRequest extends Sequence {
	...
	boolean has_subType0 = data.subType != null;
	boolean has_sendOnLessThenValue0 = data.sendOnLessThenValue != null;
	boolean has_sendOnMoreThenValue0 = data.sendOnMoreThenValue != null;
	boolean has_sendAll0 = data.sendAll != null;
	sink.writeBit(false); ++nbits;
	sink.writeBit(has_subType0); ++nbits;
	sink.writeBit(has_sendOnLessThenValue0); ++nbits;
	sink.writeBit(has_sendOnMoreThenValue0); ++nbits;
	sink.writeBit(has_sendAll0); ++nbits;
