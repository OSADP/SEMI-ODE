...
public class DataSubscriptionRequest extends Sequence implements BEREncodable, BERDecodable, DEREncodable, PEREncodable, PERDecodable {
    ...
    {
	try {
	    return DataSubscriptionRequest.encodeValue(coder, sink, this);
	} catch (Exception e) {
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "DataSubscriptionRequest");
	    throw ee;
	...
	try {
	    if (data.type == null)
		data.type = new Type();
	    Type.decodeValue(coder, source, data.type);
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
	...
	try {
	    ...
	    com.bah.ode.asn.oss.dsrc.DFullTime.decodeValue(coder, source, data.endTime);
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
    ...
    {
	try {
	    DataSubscriptionRequest.decodeValue(coder, source, this);
	    return this;
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
