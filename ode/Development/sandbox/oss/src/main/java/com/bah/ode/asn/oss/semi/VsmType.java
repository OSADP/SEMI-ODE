...
/**
 * Define the ASN1 Type VsmType from ASN1 Module SEMI.
 * @see OctetString
 */

public class VsmType extends OctetString {
     ...
     * Clone 'this' object.
     */
    public VsmType clone() {
	return (VsmType)super.clone();
    }

} // End class definition for VsmType
