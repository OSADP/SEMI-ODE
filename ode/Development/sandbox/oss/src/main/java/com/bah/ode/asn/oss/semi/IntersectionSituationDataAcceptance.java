...
public class IntersectionSituationDataAcceptance extends Sequence implements BEREncodable, BERDecodable, DEREncodable, PEREncodable, PERDecodable {
    ...
    {
	try {
	    return IntersectionSituationDataAcceptance.encodeValue(coder, sink, this);
	} catch (Exception e) {
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "IntersectionSituationDataAcceptance");
	    throw ee;
    ...
    {
	try {
	    IntersectionSituationDataAcceptance.decodeValue(coder, source, this);
	    return this;
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
