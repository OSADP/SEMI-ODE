...
/**
 * Define the ASN1 Type LaneWidth from ASN1 Module DSRC.
 * @see INTEGER
 */

public class LaneWidth extends INTEGER {
     ...
     * Clone 'this' object.
     */
    public LaneWidth clone() {
	LaneWidth copy = (LaneWidth)super.clone();
	copy.setValue(this.longValue());
	return copy;
    }

} // End class definition for LaneWidth
