...
/**
 * Define the ASN1 Type ConnectsTo from ASN1 Module DSRC.
 * @see OctetString
 */

public class ConnectsTo extends OctetString {
     ...
     * Clone 'this' object.
     */
    public ConnectsTo clone() {
	return (ConnectsTo)super.clone();
    }

} // End class definition for ConnectsTo
