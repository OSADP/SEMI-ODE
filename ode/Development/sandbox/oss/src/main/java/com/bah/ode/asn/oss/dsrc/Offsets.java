...
/**
 * Define the ASN1 Type Offsets from ASN1 Module DSRC.
 * @see OctetString
 */

public class Offsets extends OctetString {
     ...
     * Clone 'this' object.
     */
    public Offsets clone() {
	return (Offsets)super.clone();
    }

} // End class definition for Offsets
