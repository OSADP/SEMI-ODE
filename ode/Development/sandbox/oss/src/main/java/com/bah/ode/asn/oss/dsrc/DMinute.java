...
/**
 * Define the ASN1 Type DMinute from ASN1 Module DSRC.
 * @see INTEGER
 */

public class DMinute extends INTEGER {
     ...
     * Clone 'this' object.
     */
    public DMinute clone() {
	DMinute copy = (DMinute)super.clone();
	copy.setValue(this.longValue());
	return copy;
    }

} // End class definition for DMinute
