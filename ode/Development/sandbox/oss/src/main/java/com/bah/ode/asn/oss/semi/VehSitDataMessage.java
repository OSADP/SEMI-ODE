...
public class VehSitDataMessage extends Sequence implements BEREncodable, BERDecodable, DEREncodable, PEREncodable, PERDecodable {
		...
		throws IOException, DecoderException, DecodeFailedException
	{
		...
		try {
		    ...
		    VehSitRecord.decodeValue(coder, source, item1);
		} catch (Exception e) {
    ...
    {
	try {
	    return VehSitDataMessage.encodeValue(coder, sink, this);
	} catch (Exception e) {
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "VehSitDataMessage");
	    throw ee;
	...
	try {
	    ...
	    Bundle.decodeValue(coder, source, data.bundle);
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
    ...
    {
	try {
	    VehSitDataMessage.decodeValue(coder, source, this);
	    return this;
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
