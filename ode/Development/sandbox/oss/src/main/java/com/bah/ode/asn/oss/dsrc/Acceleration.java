...
/**
 * Define the ASN1 Type Acceleration from ASN1 Module DSRC.
 * @see INTEGER
 */

public class Acceleration extends INTEGER {
	...
	Acceleration copy = (Acceleration)super.clone();
	copy.setValue(this.longValue());
	return copy;
    }

} // End class definition for Acceleration
