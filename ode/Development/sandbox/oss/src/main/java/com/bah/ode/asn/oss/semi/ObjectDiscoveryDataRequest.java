...
public class ObjectDiscoveryDataRequest extends Sequence implements BEREncodable, BERDecodable, DEREncodable, PEREncodable, PERDecodable {
    ...
    {
	try {
	    return ObjectDiscoveryDataRequest.encodeValue(coder, sink, this);
	} catch (Exception e) {
	    EncoderException ee = EncoderException.wrapException(e);
	    ee.appendFieldContext(null, "ObjectDiscoveryDataRequest");
	    throw ee;
    ...
    {
	try {
	    ObjectDiscoveryDataRequest.decodeValue(coder, source, this);
	    return this;
	} catch (Exception e) {
	    DecoderException de = DecoderException.wrapException(e);
