...
public class CASClient {
   ...
   public static CASClient configure(SSLContext sslContext, String casUrl,
         String ddsUrl) throws CASException {

      CASClient casClient = new CASClient();
      casClient.setCasUrl(casUrl);
      casClient.setDdsUrl(ddsUrl);
   ...
   public String login(String username, String password) throws CASException {

      try {
         String ticketGrantingTicket = getTicketGrantingTicket(casUrl,
               username, password);
         logger.info("Got ticketGrantingTicket " + ticketGrantingTicket);

         String serviceTicket = getServiceTicket(casUrl, ticketGrantingTicket,
               ddsUrl);
         logger.info("Got serviceTicket " + serviceTicket);

         sessionID = getServiceCall(ddsUrl, serviceTicket);
   ...
   private String getServiceTicket(String server, String ticketGrantingTicket,
      ...
      try {
         ...
         HttpResponse response = httpClient.post(server + "/"
   ...
   public CASClient setCasUrl(String casUrl) {
      this.casUrl = casUrl;
      return this;
   }
   ...
   public CASClient setDdsUrl(String ddsUrl) {
      this.ddsUrl = ddsUrl.startsWith("ws") ? 
            ddsUrl.replaceFirst("ws", "http") : ddsUrl;
      return this;
   }
