...
public class VehicleDataProcessorWrapper {
	...
	/**
	 * 
	 * <numParitions> <odeVehDataFlatTopic> <ZookeeperString> <KafkaBrokerString> <SparkDuration > 
	 * 
	 */
	...
	public static void main(String[] args) {
		...
		JavaStreamingContext  ssc = new JavaStreamingContext(sparkConf,
															Durations.seconds(Integer.parseInt(sparkStreamingDefaultDuration)));
		
		ovdfWF.setup(ssc, 
					MQTopic.create(odeVehDataFlatTopic, 
