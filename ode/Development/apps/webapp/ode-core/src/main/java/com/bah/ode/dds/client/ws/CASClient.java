...
public class CASClient {
   ...
   public static CASClient configure(AppContext appContext,
         SSLContext sslContext) throws CASException {
   ...
   public String login() throws CASException {
      ...
      try {
         ...
         String websocketURL = appContext.getParam(AppContext.DDS_WEBSOCKET_URI);
